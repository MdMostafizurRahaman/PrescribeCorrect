...
export default function ChatPage() {
  ...
  useEffect(() => {
    if (currentUser) {
      ...
      const storedChatContext = localStorage.getItem('PrescribeCorrect_chat_context')
      if (storedChatContext) {
        try {
          ...
          if (chatContextData.type === 'analysis_discussion' && chatContextData.analysis) {
            ...
            localStorage.removeItem('PrescribeCorrect_chat_context') // Clear after use
  ...
  const initializeChat = async () => {
    try {
      ...
      if (messages.length === 0) {
        let welcomeMessage = 'আসসালামু আলাইকুম! 🙏\n\nআমি PrescribeCorrect এর AI সহায়ক। আপনার স্বাস্থ্য বিষয়ক যেকোনো প্রশ্ন করুন - আমি বাংলায় সাহায্য করতে পারি! 🩺💚'
  ...
  const getEnhancedLocalResponse = (message) => {
    ...
    if (greetings.some(greeting => lowerMessage.includes(greeting))) {
      let response = `আসসালামু আলাইকুম! 🙏\n\nআমি PrescribeCorrect এর AI সহায়ক। আমি আপনাকে স্বাস্থ্য বিষয়ক যেকোনো প্রশ্নের উত্তর দিতে পারি!`
    ...
    defaultResponse += `\n\nআপনার স্বাস্থ্যের যত্ন নিন, PrescribeCorrect আপনার পাশে! 💚`
